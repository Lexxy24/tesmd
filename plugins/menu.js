...
let tags = {
  ...
  'quotes': '𝗤𝘂𝗼𝘁𝗲𝘀 𝗠𝗲𝗻𝘂',
  'group': '𝗚𝗿𝗼𝘂𝗽 𝗠𝗲𝗻𝘂',
  'internet': '𝗦𝗲𝗮𝗿𝗰𝗵𝗶𝗻𝗴 𝗠𝗲𝗻𝘂',
  'anonymous': '𝗔𝗻𝗼𝗻𝘆𝗺𝗼𝘂𝘀 𝗖𝗵𝗮𝘁',
  'nulis': '𝗠𝗮𝗴𝗲𝗿 𝗠𝗲𝗻𝘂',
  'downloader': '𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗠𝗲𝗻𝘂',
  'tools': '𝗧𝗼𝗼𝗹𝘀 𝗠𝗲𝗻𝘂',
  'fun': '𝗙𝘂𝗻 𝗠𝗲𝗻𝘂',
  'owner': '𝗢𝘄𝗻𝗲𝗿 𝗠𝗲𝗻𝘂',
  'advanced': '𝗔𝗱𝘃𝗮𝗻𝗰𝗲𝗱',
...
const defaultMenu = {
  ...
  footer: '\n',
  after: `  ${'*Created By Lexxy Official 🥰*'}`,
}
...
*🤖 ɴᴀᴍᴇ: ${_package.name}*
*👤 ᴀᴜᴛʜᴏʀ: Lexxy Official*
*🌟 ᴄᴏɴᴛᴀᴄᴛ: 6282279915237*
...
*––––『 LIST-FITUR 』––––*`, text.trim(), `${timeimg()}`, [
      [`𝐁𝐎𝐓 𝐈𝐍𝐅𝐎`, `${usedPrefix}botinfo`],
      [`𝐏𝐑𝐎𝐅𝐈𝐋`, `${usedPrefix}profile`]
    ], m, {asLocation: true})
  } catch (e) {
